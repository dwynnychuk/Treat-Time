...
print(senderEmail)
print(senderSubject)
dra = EmailScrape.emailDraft('mark.sherstan@gmail.com', 'MURP','/home/pi/Documents/Treat-Time/images/2022-10-26 13:58:59.017654.jpg')
#dra = EmailScrape.emailDraft(senderEmail, senderSubject,'/home/pi/Documents/Treat-Time/images/2022-10-26 13:58:59.017654.jpg')
print(dra)
em = EmailScrape.buildFilePart('/home/pi/Documents/Treat-Time/images/2022-10-26 13:58:59.017654.jpg')
print('\nmessage is\n')
print(em)